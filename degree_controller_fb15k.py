...
def bar_chart_different_ranks(serieDifferenze):
    ...
    plt.savefig('output/different_ranks.png', transparent=True)
    plt.show()
...
for index in index_list:
    ...
    if 1 <= degreehead237  and 1 <= degreetail237 :
        ...
        print(index, '---', nome_head, '(', head, ')', 'degree', degreehead237, '--->',
              relation, '--->', nome_tail, '(', tail, ')', 'degree', degreetail237, 'FB15k-237','paths', dfs_portatile_filtered.partenza_dfs(head, tail, df_train237, 2, 2))
